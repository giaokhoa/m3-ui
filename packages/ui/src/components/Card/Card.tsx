import type { CardVariant } from '@m3/tokens/card';
import {
  useEffect,
  useRef,
  useState,
...
export interface CardProps
  ...
  children?: ReactNode;
  /** Makes the card interactive. Mirrors Compose's clickable Card overload. */
  onPress?: () => void;
  /** Only affects the clickable overload, matching Compose's enabled parameter. */
  isDisabled?: boolean;
  /** CSS border radius used as the web mapping of Compose Shape. */
  ...
  return (
    ...
    >
      <Elevation
        ...
        style={{
          transitionDuration: `${elevationMotion.durationMs}ms`,
          transitionProperty: 'box-shadow',
          transitionTimingFunction: elevationMotion.easing,
        }}
      />
