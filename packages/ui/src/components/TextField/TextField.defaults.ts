...
type TextFieldTokenSet =
  | typeof filledTextFieldTokens
  | typeof outlinedTextFieldTokens;
...
function commonTextFieldStyle(tokens: TextFieldTokenSet): TextFieldStyle {
  ...
  return {
    ...
    '--_text-field-disabled-placeholder-color': roleVariable(
      colors.disabledPlaceholder,
    ),

    '--_text-field-supporting-color': roleVariable(colors.supporting),
    '--_text-field-disabled-supporting-color': roleVariable(
      colors.disabledSupporting,
    ),
    ...
    '--_text-field-disabled-leading-icon-color': roleVariable(
      colors.disabledLeadingIcon,
    ),
    '--_text-field-disabled-trailing-icon-color': roleVariable(
      colors.disabledTrailingIcon,
    ),
    '--_text-field-error-leading-icon-color': roleVariable(colors.errorLeadingIcon),
    '--_text-field-error-trailing-icon-color': roleVariable(
      colors.errorTrailingIcon,
    ),
...
export const filledTextFieldBaseStyle: TextFieldStyle = {
  ...
  '--_text-field-focused-indicator-color': roleVariable(
    filled.colors.focusedIndicator,
  ),
  '--_text-field-disabled-indicator-color': roleVariable(
    filled.colors.disabledIndicator,
  ),
...
export const outlinedTextFieldBaseStyle: TextFieldStyle = {
  ...
  '--_text-field-focused-outline-color': roleVariable(
    outlined.colors.focusedOutline,
  ),
  '--_text-field-disabled-outline-color': roleVariable(
    outlined.colors.disabledOutline,
  ),
