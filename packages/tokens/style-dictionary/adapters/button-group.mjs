...
export function createButtonGroupCss(context) {
  ...
  const rules = [
    ...
    line('--_button-group-menu-item-height', get('component.list.base.item.oneLine.containerHeight')),
    line('--_button-group-menu-item-padding-start', get('component.list.base.item.leadingSpace')),
    line('--_button-group-menu-item-padding-end', get('component.list.base.item.trailingSpace')),
    line('--_button-group-menu-item-gap', get('component.list.base.item.betweenSpace')),
    line('--_button-group-menu-item-icon-size', get('component.list.base.item.leadingIconSize')),
    '}',
    '',
