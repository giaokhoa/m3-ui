...
export function createFabCss(context) {
  ...
  rules.push(
    ...
    '}',
    '',
    '.fab.fab--branded:not(.fab--extended) {',
  ...
  rules.push(
    ...
    '}',
    '',
    '.fab--extended.fab--branded-extended {',
    ...
    '',
    '.fab--extended {',
    line('--_fab-expand-size-duration', get('motion.spring.fastSpatial.duration')),
    line('--_fab-expand-size-easing', get('motion.spring.fastSpatial.easing')),
    line('--_fab-expand-opacity-duration', get('motion.spring.fastEffects.duration')),
    line('--_fab-expand-opacity-easing', get('motion.spring.fastEffects.easing')),
    '}',
    '',
  );
