...
export function createTimePickerCss(context) {
  ...
  return [
    ...
    line('--_tp-vibrant-container-shape', shape('extraLarge')),
    line('--_tp-vibrant-field-shape', shape('large')),
    line('--_tp-vibrant-period-shape', shape('full')),
    line('--_tp-vibrant-time-field-width', get(`${picker}.vibrantTimeFieldWidth`)),
    line('--_tp-vibrant-time-field-portrait-24-width', get(`${picker}.vibrantTimeFieldPortrait24Width`)),
    line('--_tp-vibrant-time-field-height', get(`${picker}.vibrantTimeFieldHeight`)),
    line('--_tp-vibrant-separator-width', get(`${picker}.vibrantSeparatorWidth`)),
    line('--_tp-vibrant-period-width', get(`${picker}.vibrantPeriodSelectorWidth`)),
    line('--_tp-vibrant-period-height', get(`${picker}.vibrantPeriodSelectorHeight`)),
    line('--_tp-vibrant-period-padding', get(`${picker}.vibrantPeriodSelectorPadding`)),
    line('--_tp-vibrant-period-large-padding', get(`${picker}.vibrantPeriodSelectorLargePadding`)),
